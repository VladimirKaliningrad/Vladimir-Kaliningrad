...
const number1 = Number.parseInt(prompt("Здравствуйте, преобразователь покажет температуру по Фаренгейту. Вводите корректное число! Введите температуру в градусах Цельсия"));
