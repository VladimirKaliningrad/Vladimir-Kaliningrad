...
$works = [
    ...
    [
      "name" => "Оперативник силовых структур",
      "dateStart" => "сентябрь 2015",
      "dateEnd" => "по настоящее время",
      "description" => "Выявление и раскрытие преступлений, сопровождение уголовных дел",
    ],
    [
        "name" => "следователь МВД",
        "dateStart" => "январь 2003",
        "dateEnd" => "август 2015",
        "description" => "Расследдование общих, экономических уголовных дел",
    ],
